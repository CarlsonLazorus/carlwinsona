...
if (isset($_POST['submit'])) {
    if (isset($_POST['username']) && isset($_POST['phone']) &&
        isset($_POST['attend']) && isset($_POST['totalAttend']) && isset($_POST['guest1']) &&
        isset($_POST['guest2']) && isset($_POST['guest3']) && isset($_POST['guest4']) && 
        isset($_POST['guest5']) && isset($_POST['wish'])) {
